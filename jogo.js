...
function cria_baloes(qtde_baloes){
	...
	for(var i = 1; i <= qtde_baloes; i++){
		...
		balao.src = 'melgrande.png'; //Aqui eu atribuo uma foto a esse elemento e embaixo eu dou uma imagem//
...
function estourar(e){ //Função de estourar os balões recebida com o parametro dps do evento click aqui e e assim explorando os elementos dessa função
	...
	document.getElementById(id_balao).src = 'estourogrande.png'; //Troca a imagem de balão normal para estourado
